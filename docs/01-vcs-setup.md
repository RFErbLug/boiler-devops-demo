...
* `01-vcs/l5x-source/BoilerDemo.L5X`
* `01-vcs/exploded-content/RSLogix5000Content/`
...
1. Open your ACD in Studio 5000
2. Go to `Tools -> Commit`
3. When prompted for the target directory, choose your exploded content folder

Example:

`Path to your repo\01-vcs\exploded-content`

4. If prompted for a commit message, enter one
